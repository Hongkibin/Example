...
public class Mypage  extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EditText editText = (EditText) findViewById(R.id.name); //제품명
...
//        View view = inflater.inflate(R.layout.activity_category_cream, null);
//        Button button84 = (Button)view.findViewById(R.id.button84);
//        name.setText(button84.getText().toString());
   ...
   // String name1 = intent.getExtras().getString("name1");
        ...
        finishText = (TextView) findViewById(R.id.finish); //유통기한 날짜 뜨는 거
        dateButton = (Button) findViewById(R.id.dateButton); //제조일자
...
/*
final  TextView finishText = (TextView) findViewById(R.id.finish);
int date1 = Integer.parseInt(finishText.getText().toString());
        int responseListener = 0;
        Mypage_Request Mypage_Request= new Mypage_Request(date1,responseListener);
...
*/
    ...
    private void updateDisplay2() {
        finishText.setText(String.format("%d년 %d월 %d일",   tYear+1, tMonth - 5 , tDay));
    }
    private void updateDisplay3() {
        finishText.setText(String.format("%d년 %d월 %d일",   dYear+3, dMonth+1 , dDay));
    }
